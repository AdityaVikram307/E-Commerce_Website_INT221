        ...
        <div class="row">
          <div class="col-md-12">
            <div class="aa-header-bottom-area">
              <div class="aa-logo">
                <a href="{{url('/')}}">
                  <span class="fa-solid fa-cart-shopping-fast"></span>
                  <p>E<strong>-Shop</strong> <span>Your E-Commerce Partner</span></p>
                </a>
                <!-- img based logo -->
                  ...
                  <div class="aa-footer-widget">
                    <div class="aa-footer-widget">
                      ...
                      <address>
                        ...
                        <p><span class="fa fa-envelope"></span>adityavikram@gmail.com</p>
                      </address>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="aa-footer-bottom-area">
              <p>Designed by <a href="#">Aditya Vikram</a></p>
